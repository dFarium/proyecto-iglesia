...
const UserSchema = new Schema<IUsuarioModel>({
    ...
    telefono: {type: String, unique: true, minlength:9, maxlength:10, default: null},
    direccion: {type: String, default: null},
    fecha_nacimiento: {type: Date, require: false, default: null},
    num_emergencia: {type: String, minlength:9, maxlength:10, default: null},
...
export const schemaRegister = Joi.object({
    ...
    telefono: Joi.string().min(9).max(10),
    direccion: Joi.string(),
    fecha_nacimiento: Joi.date(),
    num_emergencia: Joi.string().min(9).max(10),
    estado: Joi.string(),
